...
import { IMPORT_PRODUCTS } from "@/content/products";
...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Products Epic Trading sources and imports for Ethiopian buyers: construction materials, machinery and industrial equipment, and vehicles.",
    ...
    <>
      <section className="relative overflow-hidden bg-forest-950 pb-16 pt-16 text-sand-50">
        ...
        <Container className="relative">
          <Breadcrumbs tone="light" items={[{ label: "Home", href: "/" }, { label: "Import Products" }]} />
          <h1 className="mt-6 max-w-3xl font-display text-display-lg font-medium">Import Products</h1>
          <p className="mt-5 max-w-2xl text-[16.5px] leading-relaxed text-sand-300">
            Products sourced internationally and coordinated for delivery to Ethiopian and regional buyers.
          </p>
        </Container>
      </section>
      ...
      <CTASection
        title="Sourcing materials, machinery or vehicles?"
        description="Submit a request and our team will follow up with a structured quotation."
        primaryLabel="Construction Materials"
        primaryHref="/enquiry/construction"
        secondaryLabel="Machinery Request"
        secondaryHref="/enquiry/machinery"
      />
    </>
  );
}
